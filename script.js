...
const arr = ["20240405060243", "20240515053250"]; // Add your timestamps here

const xhr = new XMLHttpRequest();
xhr.open("GET", `https://corsproxy.io{arr[Math.floor(Math.random()*arr.length)]}if_%2Fhttps%3A%2F%2Fi.l4r.io%2F&key=12345678`, true);
...
xhr.onload = function() {
  ...
  const loadNextImage = () => {
    ...
    image.src = "https://l4r.io" + encodeURI(keys[i].textContent.trim());
